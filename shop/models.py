...
class Color(models.Model):
    ...
    hex_value = models.CharField(max_length=7)  # برای ذخیره کد رنگ به صورت Hex (مثل #FFFFFF)
...
class Order(models.Model):
    ...
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='در انتظار')
...
class Review(models.Model):
    ...
    rating = models.PositiveSmallIntegerField()  # بین 1 تا 5
...
class UserProfile(models.Model):
    ...
    gender = models.CharField(max_length=10, choices=[('male', 'مرد'), ('female', 'زن')], blank=True)
...
class ProductLimit(models.Model):
    product = models.ForeignKey(Product, related_name='purchase_limits', on_delete=models.CASCADE)
